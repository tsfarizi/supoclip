...
from .shared.config import Config, get_config, set_config_override
from .infra.db import AsyncSessionLocal, close_db, configure_database, get_db, init_db
from .infra.media_tools import ensure_media_tools_on_path
    ...
    *,
    ...
    async def lifespan(app: FastAPI):
        ...
        try:
            ...
            from .infra.cache.redis_client import close_redis_clients
